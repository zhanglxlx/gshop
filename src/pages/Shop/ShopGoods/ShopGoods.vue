...
<script>
// better-scroll 是一款解决移动端(现在支持pc端)各种滚动场景需求的插件 他的核心是借鉴iscroll的实现,他的api设计基本兼容iscroll,在iscroll的基础上又扩展的了一些feature以及做了一些性能优化 https://github.com/ustbhuangyi/better-scroll/blob/master/README_zh-CN.md
