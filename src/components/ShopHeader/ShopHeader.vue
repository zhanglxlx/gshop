<template>
  <div class="shop-header">
    ...
    <nav class="shop-nav" style="backgroundImage:url(./images/images/meat.jpg)">
      <!-- 导航的信息 -->
    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <img class="content-image" src="./images/images/bread.jpg">
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShopShow">
            <span class="icon iconfont icon-guanbi7-01"></span>
          </div>
        </div>
